...
const ProductDetailScreen = () => {
    ...
    const { data: twoYearSalesData } = useProductSalesStats({
        producto: Number(id),
    ...
    const { data: productStockSucursalesData } = useProductStock({
        producto: Number(id),
        sucursal: selectedBranchId ? Number(selectedBranchId) : 0,
        resto_only: 1
    })

    const { data: productProviderOrders } = useProductProviderOrders({
        producto: Number(id),
        sucursal: selectedBranchId ? Number(selectedBranchId) : 0,
    })
    ...
    useEffect(() => {
        ...
        console.log("Stovk Data:", productStockLocalData)
